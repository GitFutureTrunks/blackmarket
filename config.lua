...
Config.deliveryLocations = {
    vector4(717.48, 1546.54, 2.72, 274.26),
    vector4(916.38, 490.87, 5.95, 191.5), 
    vector4(985.74, 218.62, 5.83, 245.14), 
    vector4(2422.03, 543.76, 5.79, 358.26), 
    vector4(2411.56, 467.01, 5.78, 4.87),
}
